...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        { src: "http://img.b2bpic.net/free-photo/handsome-business-man-wearing-suit-looking-camera-smiling-broadly-with-happy-face-standing-white-background_141793-54115.jpg", alt: "Client Three" },
        { src: "http://img.b2bpic.net/free-photo/close-up-young-businesswoman_23-2149153828.jpg", alt: "Client Four" },
        { src: "http://img.b2bpic.net/free-photo/medium-shot-smiley-woman-work_23-2149097959.jpg", alt: "Client Five" }
      ]}
      avatarText="Trusted by 500+ professionals"
      marqueeItems={[
        { type: "text", text: "24/7 Monitoring" },
        { type: "text", text: "Rapid Response" },
        { type: "text", text: "Elite Security Personnel" },
        { type: "text", text: "Risk Management" },
        { type: "text", text: "Compliance Experts" }
      ]}
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      useInvertedBackground={false}
      features={[
        { id: "1", label: "01", title: "Physical Security", items: ["On-site guarding", "Access control", "Patrol services"] },
        { id: "2", label: "02", title: "Surveillance", items: ["Remote CCTV monitoring", "Alarm response", "System audits"] },
        { id: "3", label: "03", title: "Risk Consulting", items: ["Vulnerability assessment", "Security planning", "Training programs"] }
      ]}
  ...
  <div id="metrics" data-section="metrics">
      ...
      useInvertedBackground={false}
      metrics={[
        { id: "m1", value: "24/7", title: "Support Availability", items: ["Emergency response", "Technical support", "On-site backup"] },
        { id: "m2", value: "<5min", title: "Average Response", items: ["Rapid deployment", "Alarm validation", "Swift dispatch"] },
        { id: "m3", value: "99.9%", title: "System Uptime", items: ["High-tech integration", "Regular maintenance", "Reliable connectivity"] }
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "t1", name: "Sarah Jenkins", imageSrc: "http://img.b2bpic.net/free-photo/blond-businessman-sad-expression_1194-3905.jpg" },
        { id: "t2", name: "David Thorne", imageSrc: "http://img.b2bpic.net/free-photo/smiling-businessman-standing-airport_107420-85035.jpg" },
        { id: "t3", name: "Robert Chen", imageSrc: "http://img.b2bpic.net/free-photo/positive-confident-businessman-posing-outside_74855-1183.jpg" },
        { id: "t4", name: "Lisa Montgomery", imageSrc: "http://img.b2bpic.net/free-photo/portrait-smiley-modern-male_23-2148514900.jpg" },
        { id: "t5", name: "James Anderson", imageSrc: "http://img.b2bpic.net/free-photo/handsome-groom-classy-black-suit-stands-dark-room_8353-7083.jpg" }
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "f1", title: "What areas do you serve?", content: "We provide nationwide coverage for commercial and industrial clients." },
        { id: "f2", title: "Are your guards licensed?", content: "Yes, every single member of our team is fully licensed and vetted." },
        { id: "f3", title: "How quickly can we start?", content: "We can deploy site security solutions within 48 hours for urgent requirements." }
      ]}
  ...
  <div id="footer" data-section="footer">
      ...
      columns={[
        { title: "Services", items: [{ label: "Security Guards", href: "#" }, { label: "Surveillance", href: "#" }] },
